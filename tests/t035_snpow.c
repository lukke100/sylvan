...
int main(void)
{
	...
	assert(snpow(0,     -1, NULL) == INT_MAX);
	assert(snpow(0,  32766, NULL) == 0);
	assert(snpow(0, -32766, NULL) == INT_MAX);
	assert(snpow(0,  32767, NULL) == 0);
	assert(snpow(0, -32767, NULL) == INT_MAX);
